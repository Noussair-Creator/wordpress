...
<head>
    <meta charset="UTF-8">
    <title>Dashboard - Service Mastère</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-0">
                ...
                <div class="content p-4">
                    <!-- Top Boxes (disponibilites, calendriers, carrousel) -->
                    <?php include 'components/Top-Boxes-Utm.php'; ?>

                    <!-- Stats Graphs (3 graphiques) -->
                    <?php include 'components/Statistiques/statUtmMaster.php'; ?>

                    <?php include 'components/listing-card.php'; ?>

                    <!-- Card Grid (modules) -->
                    <?php include 'components/Card-Grid-utm.php'; ?>
                </div>
            </div>
        </div>
    </div>
