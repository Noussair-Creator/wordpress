...
require_once 'requireApi.php'; // si besoin d'authentification personnalisée
...
<head>
    <meta charset="UTF-8">
    <title>Dashboard - Coordinateur MASTER</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-0">
                ...
                <div class="content p-4">
                    ...
                    <!-- Card Grid (modules) -->
                    <?php include 'components/Coordinateur/Card-Grid.php'; ?>
                </div>
            </div>
        </div>
    </div>
