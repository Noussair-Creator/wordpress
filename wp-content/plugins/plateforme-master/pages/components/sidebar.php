...
<div class="sidebar">
  <div class="user">
    ...
    <?php if (!empty($data['profil_nom'])): ?>
      <p style="font-size: 15px;color:#b60303; font-weight:600; text-transform:uppercase;margin-top:-20px">
        <?= $data['profil_nom'] ?>
      </p>
    <?php endif; ?>
  </div>
  ...
  <?php else: ?>
    <p style="color: #999; text-align: center; font-size: 14px; margin-top: 20px;">Aucun menu disponible pour ce profil.
    </p>
  <?php endif; ?>
