...
<!-- Bloc Indicateurs -->
<div class="master-feature-card">
  <div class="feature-text">Convention de coordination</div>
...
.card.with-image.card2 {
  background-image: url('/wp-content/plugins/plateforme-master/imagesED/d9eb867c-8b57-4ed9-9853-6f667e4ee124.jpg');
  background-size: cover;
  background-repeat: no-repeat;
  padding-top: 35px;
  padding-bottom: 35px;
