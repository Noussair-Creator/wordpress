        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-0">
                ...
                <div class="content p-4">
                    ...
                    <?php include 'components/InfoDonneFisheIndividuelle.php' ?>
                    <?php include 'components/TableauFisheIndividuelle.php' ?>
                    <?php include 'components/CommentFisheIndividuelle.php' ?>
                </div>
            </div>
        </div>
    </div>
