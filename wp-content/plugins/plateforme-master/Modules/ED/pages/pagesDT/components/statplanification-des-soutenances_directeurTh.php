<div class="statistiques-wrapper">
    ...
    <div class="stats-grid">
        ...
        <div class="left-stats">
            <div class="stat-box">
                <span class="label">Nombre de thèses soutenues</span>
                <span class="value">5</span>
            </div>
            <div class="stat-box">
                <span class="label">Moyenne de délai entre dépôt et soutenance</span>
                <span class="value">43j</span>
            </div>
        </div>
        ...
        <div class="right-graph">
            <div class="graph-header">
                <h4>Répartition par statut de soutenances</h4>
...
<script>
const labels = ['Soutenances Confirmée', 'Soutenances Sans Jury Complet', 'Soutenances en attente'];
const dataValues = [66, 24, 10];
const colors = ['#808066', '#BF0404', '#dabebe'];
