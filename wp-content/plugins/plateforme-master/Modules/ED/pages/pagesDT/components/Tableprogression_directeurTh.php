...
<div class="content-block">
    <div class="header-bar">
        <h2 class="dashboard-sub-title">
            ...
            Tableau synthétique de progression
        </h2>
        ...
        <div class="filter-inputs">
            ...
            <div class="input-with-icon">
                <select class="filter-select">
                    <option value="" disabled selected>Sujet Thèse</option>
                    <option>Analyse Chimique De L’eau</option>
                    <option>Optimisation Des Graphes</option>
                    <option>Génétique Végétale Appliquée</option>
            ...
            <div class="input-with-icon">
                <select class="filter-select">
                    ...
                    <option>4ᵉ Année</option>
                    <option>3ᵉ Année</option>
                    <option>2ᵉ Année</option>
                    <option>1ᵉ Année</option>
                </select>
                <i class="fas fa-chevron-down icon right-icon"></i>
            </div>
        </div>
    ...
    <table id="candidaturesTable" class="styled-table display">
        ...
        <tbody>
            <tr>
                ...
                <td>Analyse Chimique De L’eau</td>
                <td>2ᵉ Année</td>
                <td>58 %</td>
                <td>Oui</td>
                <td>12-05-2025</td>
                <td>
                    <div class="actions">
                        ...
                        <div class="dropdown-menu">
                            <a href="#"><i class="fa-regular fa-eye"></i> Voir fiche</a>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td><input type="checkbox"></td>
                <td>Fatma Jouini</td>
                <td>Optimisation Des Graphes</td>
                <td>4ᵉ Année</td>
                <td>65 %</td>
                <td>Non</td>
                <td>30-04-2025</td>
            ...
            <tr>
                ...
                <td>Génétique Végétale Appliquée</td>
                <td>1ᵉ Année</td>
                <td>35 %</td>
                <td>Oui</td>
                <td>22-06-2025</td>
