...
<div class="dashboard-bar">
  <div class="dashboard-title"><?php  echo '<a href="' . esc_url($parent_link) . '">' . esc_html($parent_title) . '</a>';  echo ' <span class="title-active">' . get_the_title($current_id) . '</span>';?></div>
  <div class="dashboard-icons">
    ...
    <div class="icon-box has-badge"><i class="fas fa-bell"></i><span class="badge-dot">2</span></div>
      ...
      <div class="icon-box">
        <a href="/profil" class="icon-box" title="Profil">
