...
<head>
    <meta charset="UTF-8">
    <title>Evaluations & Rapports</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-0">
                ...
                <div class="content p-4">
                    ...
                    <?php include 'components/statevaluations-et-rapports_directeurTh.php' ?>
                    <?php include 'components/Tableevaluations-et-rapports_directeurTh.php' ?>
                </div>
            </div>
        </div>
    </div>
