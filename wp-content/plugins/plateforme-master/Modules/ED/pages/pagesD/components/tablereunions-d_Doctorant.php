...
<div class="content-block">
    <div class="header-bar">
        ...
        <!-- Buuton Ajouter Programmer une réunion -->
    ...
    <div class="popup-container">
        <div class="popup-header">
            ...
            <div class="header-actions">
                ...
                <button disabled class="btn-close-x" id="closeModalBtn">×</button>
            </div>
        </div>
        <form class="popup-form">
            ...
            <div class="form-group">
                ...
                <ul id="participantList" class="participant-list">
                    <!-- Example participants based on the screenshot -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Handle pre-existing participant delete buttons ---
    // This makes the delete buttons on the example participants work
    ...
    const closeModal = () => {
        ...
        // NOTE: We don't clear the form on close anymore to keep the examples
        // If you want to clear it, you can add the form-clearing logic back here.
    };
    ...
    saveBtn.addEventListener('click', () => {
        ...
        const participants = Array.from(participantList.children).map(li => li.firstChild
            .textContent);
