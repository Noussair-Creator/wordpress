<div class="statistiques-wrapper">
    <div class="header-bar">
        ...
        <button class="btn-report">
            <img width="20px" src="/wp-content/plugins/plateforme-master/images/icons/27) Icon-Sync.png"
                alt="Icon-Sync.png">
            Générer un rapport global</button>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="left-stats">
            <div class="stat-box">
                <span class="label">Total des <br> demandes </span>
                <span class="value">5</span>
            </div>
            <div class="stat-box">
                <span class="label">Demandes <br> Validées</span>
...
<script>
const labels = ['En attente', 'Refusées', 'Validées'];
