<!-- External CSS for Icons and Libraries -->
...
<div class="content-block">
    <h2 class="dashboard-sub-title" style="margin-bottom: 20px;">Suivi des demandes</h2>

    <div class="filter-bar" style="justify-content: space-between;">
        <div class="filter-inputs">
            <div style="display: flex; border: 1px solid #ccc; border-radius: 6px; align-items: center;">
                <input class="filter-input" type="text" placeholder="Recherche..."
                    style="border: none; height: 40px; width: 180px;">
                <button class="search-btn"
                    style="border: none; background: transparent; color: #666; padding-right: 12px;"><i
                        class="fas fa-search"></i></button>
            </div>
            <div class="input-with-icon">
                <select class="filter-select">
                    <option value="" disabled selected>Lieu</option>
                    <option>ENSI Tunis</option>
        ...
        <div class="filter-actions" style="position: static; gap: 10px; display: flex; align-items: center;">
            <a href="/demandes_doctorant" class="add-project-btn">Nouvelle demande</a>
    ...
    <table id="candidaturesTable" class="styled-table display">
        ...
        <tbody>
            <tr>
                ...
                <td>CRD-2025-001</td>
                <td>École D'été En IA</td>
                <td>05/07/2025</td>
                <td>ENSI Tunis</td>
                <td style="width: 70.2955px;">3</td>
                <td style="width: 70.2955px;">3</td>
                <td><span class="badge badge-success"><i class="fa-regular fa-circle-check"
                            style="margin-right: 4px;"></i>Validée</span></td>
                <td>
                    <div class="actions">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="#">
                                <img style="margin-right: 8px; width: 14px;"
                            ...
                            <a href="#"><i class="fas fa-trash-alt"
                                    style="margin-right: 8px; width: 14px;"></i>Supprimer</a>
                            <a href="#">
                                <!-- <i class="fas fa-eye" style="margin-right: 8px; width: 14px;"></i> -->
                                <img style="margin-right: 8px; width: 18px;"
                                    src="/wp-content/plugins/plateforme-master/images/icons/27) Icon-eye.png"
                                    alt="Icon-eye.png"> Détails
                            </a>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td><input type="checkbox"></td>
                <td>CRD-2025-002</td>
                <td>Séminaire En Biotech</td>
                <td>05/07/2025</td>
                <td>En Ligne</td>
                <td>2</td>
                <td>-</td>
                <td><span class="badge badge-warning"><i class="fa-regular fa-clock" style="margin-right: 4px;"></i>En
                        cours</span></td>
                <td>
                    <div class="actions">
                        <button class="action-btn">...</button>
                        <div class="dropdown-menu">
                            <a href="#">
                                <!-- <i class="fas fa-pencil-alt"style="margin-right: 8px; width: 14px;"></i> -->
                                <img style="margin-right: 8px; width: 14px;"
                                    src="/wp-content/plugins/plateforme-master/images/icons/27) Icon-edit-2.png"
                                    alt="Icon-edit-2.png">
                                Modifier
            ...
            <tr>
                <td><input type="checkbox"></td>
                <td>CRD-2025-003</td>
                <td>Workshop En Datasci</td>
                <td>05/07/2025</td>
                <td>UTM</td>
                <td>1</td>
                <td>0</td>
                <td><span class="badge badge-danger"><i class="fa-regular fa-circle-xmark"
                            style="margin-right: 4px;"></i>Refusée</span></td>
                <td>
                    <div class="actions">
                        <button class="action-btn">...</button>
                        <div class="dropdown-menu">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    actionButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            currentMenu.style.display = currentMenu.style.display === 'block' ? 'none' :
                'block';
        });
    });
    ...
    $('#candidaturesTable').DataTable({
        ...
        pageLength: 5,
        dom: 'Bfrtip',
        buttons: [], // Initially no buttons, can be configured if needed
        language: {
            paginate: {
    ...
    //         // Uncomment the modal HTML to use this functionality
    //         // openmodalObjectifs();
    //         alert("Modal HTML is currently commented out.");
    //     });
    // }
