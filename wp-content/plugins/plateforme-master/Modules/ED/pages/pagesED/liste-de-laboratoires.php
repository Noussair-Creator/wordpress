...
<head>
    <meta charset="UTF-8">
    <title>Liste des laboratoire</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 p-0 sidbarcol">
                <?php include 'components/sidebarUTM.php'; ?>
            </div>
            ...
            <div class="col-md-9 col-lg-10 p-0">
                ...
                <div class="content p-4">
                    ...
                    <?php // include 'components/Statistiques/statmembres.php'; ?>
                    <?php // include 'components/Tablemembres.php'; ?>

                    <?php // include 'components/modalAffectation.php'; ?>
                    <?php // include 'components/ModaladdMaster.php'; ?>
                    <?php include 'components/liste-de-laboratoires.php'; ?>
