...
<head>
  <meta charset="UTF-8">
  <title> Contrats Post-Doctoraux</title>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-9 col-lg-10 p-0">
        ...
        <?php include 'components/Statistiques/statContrats-post-doctoraux.php'; ?>
        <?php include 'components/TableContrats-post-doctoraux.php'; ?>
