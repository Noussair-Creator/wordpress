...
<head>
  <meta charset="UTF-8">
  <title> Admissions Doctorants Étrangers</title>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-9 col-lg-10 p-0">
        ...
        <?php include 'components/Statistiques/statadmissions-doctorants-etrangers.php'; ?>
        <?php include 'components/Tableadmissions-doctorants-etrangers.php'; ?>
