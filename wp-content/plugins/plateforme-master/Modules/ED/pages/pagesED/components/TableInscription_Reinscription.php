<div class="content-block">
  <div class="header-bar">
    <h2>
      <img src="/wp-content/plugins/plateforme-master/images/ed/16406436.png" alt="Icon" style="width: 40px; margin-right: 8px; vertical-align: middle;">
  ...
  <table id="candidaturesTable" class="styled-table display">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><i class="fa fa-paperclip"></i> <span class="doc-count">3</span></td>
        <td>
          <div class="actions">
            <button class="action-btn">⋮</button>
            <div class="dropdown-menu">
              <a href="#"><i class="fa fa-eye"></i> Voir dossier</a>
