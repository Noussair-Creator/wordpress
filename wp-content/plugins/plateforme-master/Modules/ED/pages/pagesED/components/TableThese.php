<div class="content-block">
  ...
  <div class="filter-bar">
    <div class="filter-selectgb">
      <select class="filter-select">
        ...
        <option>Directeur de Labo</option>
      </select>

      <select class="filter-select">
        <option>Laboratoire</option>
        <option>LAMSIN</option>
        <option>LAREQUAD</option>
      </select>
    </div>
  ...
  <tbody>
    <tr>
      ...
      <td>Optimisation Énergétique Dans Les Smart Grids</td>
      <td>Pr. M. Ben Said</td>
      ...
      <td>
        <div class="actions">
          ...
          <div class="dropdown-menu">
            <a href="#"><i class="fa fa-eye"></i> Voir fiche</a>
            <a href="#"><i class="fa fa-envelope"></i> Envoyer mail</a>
          </div>
        </div>
      </td>
    </tr>
    <tr>
      <td><input type="checkbox"></td>
      <td>Systèmes Embarqués Autonomes Pour l’Agriculture</td>
      <td>Dr. I. Ferchichi</td>
    ...
    <tr>
      <td><input type="checkbox"></td>
      <td>Modélisation Des Systèmes Biologiques Complexes</td>
      <td>Pr. H. Mejri</td>
      <td><span class="badge badge-success">Publié</span></td>
      <td>11-09-2025</td>
      <td>4 Candidats</td>
