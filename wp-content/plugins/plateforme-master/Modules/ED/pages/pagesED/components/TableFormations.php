<div class="content-block">
  ...
  <div class="accordion-tabs">
    <button class="tab-btn active" data-tab="tab1">Suivi des doctorants</button>
    <button class="tab-btn" data-tab="tab2">Gestion des formations</button>
  </div>

    <div class="accordion-content">
      <div class="tab-panel active" id="tab1">
        <!-- Tableau Suivi des doctorants -->
        ...
        <div class="table-controls">
          <div class="filter-selectgb">
            ...
            <select class="filter-select">
              ...
              <option value="Ajout">À jour</option>
        ...
        <table class="styled-table">
          <thead>
            <tr>
              ...
              <th>Doctorant</th>
              <th>Total Crédits / Requis</th>
              <th>Formations suivies</th>
              <th>Dernière activité</th>
              <th>Statut Pédagogique</th>
              <th>Consulter</th>
              <th>Actions</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td>Manel Ben Ayed</td>
              <td>15 / 30</td>
              <td>Méthodo. Recherche, Éthique</td>
              <td>10/04/2025</td>
            ...
            <tr>
              ...
              <td>Anis Hammami</td>
              <td>30 / 30</td>
              <td>Éthique, Rédaction Scientifique, PFE</td>
              <td>20/04/2025</td>
            ...
            <tr>
              ...
              <td>–</td>
              <td>–</td>
              <td><span class="badge badge-danger">Aucun crédit</span></td>
              <td><i class="fa fa-eye"></i></td>
              <td>
                <div class="actions">
                  <button class="action-btn">⋮</button>
      ...
      <div class="tab-panel" id="tab2">
        <!-- Tableau Gestion des formations -->
        <div class="table-controls">
          <div class="filter-selectgb">
            <input type="text" class="filter-input" placeholder="Formateur...">
            <select class="filter-select">
              <option>Modalité</option>
