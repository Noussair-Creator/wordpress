<div class="content-block">
  <div class="header-bar">
    <h2>
      <img src="/wp-content/plugins/plateforme-master/images/ed/16406436.png" alt="Icon" style="width: 38px; margin-right: 8px; vertical-align: middle;">
      Tableau de suivi des candidatures post-doc
    </h2>
  </div>
  ...
  <table id="candidaturesTable" class="styled-table display">
    <thead>
      <tr>
        ...
        <th>Candidat</th>
        <th>Thèse soutenue en</th>
        <th>Spécialité</th>
        <th>Partenaire d’accueil</th>
    ...
    <tbody>
      <tr>
        ...
        <td>Pr. Sami Bousnina</td>
        <td>2024</td>
        <td>Chimie Analytique</td>
        <td>Université De Lyon</td>
        <td><span class="badge badge-success">Signé</span></td>
        <td>01/03/2025</td>
        <td>01/03/2026</td>
        <td>
          <div class="actions">
      ...
      <tr>
        <td><input type="checkbox"></td>
        <td>Dr. Leila Kchouk</td>
        <td>2023</td>
        <td>Informatique</td>
        <td>CNRS Bordeaux</td>
        <td><span class="badge badge-warning">En Négociation</span></td>
        <td>–</td>
        <td>–</td>
        <td>
          <div class="actions">
      ...
      <tr>
        <td><input type="checkbox"></td>
        <td>Pr. Hatem El Gharbi</td>
        <td>2024</td>
        <td>Biotechnologie</td>
        <td>Pasteur Lille</td>
        <td><span class="badge badge-danger">Refusé Partenaire</span></td>
        <td>–</td>
        <td>–</td>
        <td>
          <div class="actions">
