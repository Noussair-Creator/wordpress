...
<head>
    ...
    <title>Publications et Stages</title>
    ...
    .etat-these-header img.etat-icon {
        width: 32px;
        height: 32px;
    }

    .etat-these-header h3 {
        font-size: 20px;
        color: #2a2a2a;
        font-weight: bold;
    }

    .etat-these-body .etat-these-row {
        display: flex;
        justify-content: space-between;
        padding: 8px 0;
    ...
    .etat-these-body .etat-these-row span {
        font-size: 15px;
        font-weight: 500;
    }

    .etat-these-body .etat-these-row em {
        font-style: italic;
        font-size: 13px;
        color: #888;
    }
    ...
    table.etat-these-table {
        width: 100%;
    }

    table.etat-these-table tbody tr:first-child td:first-child {
        border-top-left-radius: 12px !important;
        width: 32%;
    }
    ...
    /* New styles for the updated tab1 content */
    .toolbar {
        display: flex;
        justify-content: space-between;
        align-items: center;
    ...
    .pagination-controls .dataTables_paginate {
    ...
    .website-input-container .fa-globe {
        position: absolute;
        right: 12px;
        top: 50%;
        transform: translateY(-50%);
    ...
    <div class="content-block">
        <div class="accordion-container">
            ...
            <div class="accordion-content">
                ...
                <!-- Onglet 1 : Académiques / Doctorants (Updated Content) -->
                <div class="tab-panel active" id="tab1">
                    <div class="toolbar">
                        <div class="search-container">
                            <input type="text" id="contactsSearch" placeholder="Recherche">
                    ...
                    <table id="contactsTable" class="styled-table contacts-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><img src="https://placehold.co/32x32/EFEFEF/AAAAAA?text=MH" alt="Avatar"
                                        class="avatar"> Mr. Mourad Hammami</td>
                                <td>Doctorant</td>
                            ...
                            <tr>
                                <td><input type="checkbox"></td>
                                <td><img src="https://placehold.co/32x32/EFEFEF/AAAAAA?text=SB" alt="Avatar"
                                        class="avatar"> Mr. Salah Ben Hsin</td>
                                <td>Encadrant</td>
                ...
                <!-- Onglet 2 : Stages Et Missions -->
                <div class="tab-panel" id="tab2">
                    <div class="toolbar">
                        <div class="search-container">
                            <input type="text" id="partnersSearch" placeholder="Recherche">
                            <i class="fas fa-search"></i>
                        </div>
                        <div class="actions-container">
                    ...
                    <table id="partnersTable" class="styled-table contacts-table">
                        <thead>
                            <tr>
                                <th><input type="checkbox"></th>
                        ...
                        <tbody>
                            <tr>
                                <td><input type="checkbox"></td>
                                <td><img src="https://placehold.co/32x32/00008B/FFFFFF?text=AI" alt="Logo"
                                        class="avatar"> AI Tech Solutions</td>
                                <td>IA Industrielle</td>
                                <td><img src="https://placehold.co/32x32/EFEFEF/AAAAAA?text=KJ" alt="Avatar"
                                        class="avatar"> Mr. Karim J.</td>
                                <td>+216 25 37 45 90</td>
                            ...
                            <tr>
                                <td><input type="checkbox"></td>
                                <td><img src="https://placehold.co/32x32/4682B4/FFFFFF?text=TS" alt="Logo"
                                        class="avatar"> Tech Solutions</td>
                                <td>IA Industrielle</td>
                                <td><img src="https://placehold.co/32x32/EFEFEF/AAAAAA?text=MJ" alt="Avatar"
                                        class="avatar"> Mr. Mourad J.</td>
                                <td>+216 25 37 45 90</td>
        ...
        <div class="popup-container" id="popupContainerObjectifs">
            ...
            <form class="popup-form">
                ...
                <div class="phone-input-container">
                    ...
                    <input type="tel" placeholder="+216 XX XX XX XX">
                </div>
                <select>
                    <option disabled selected>Liste Des Masters</option>
                    <option>IA & Data</option>
                    <option>Autre Master</option>
                </select>
            </form>
        </div>
    </div>

    <!-- Modal HTML for Tab 2 -->
    <div class="modal-overlay" id="modalDocumentsManquants" style="display: none;">
        <div class="popup-container" id="popupContainerDocumentsManquants">
            <div class="popup-header">
                <h2>Ajouter Contact</h2>
                <button class="btn-enregistrer" id="btnSaveDocuments">Enregistrer</button>
            </div>
            <form class="popup-form">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', function(e) {
            if ($(e.target).hasClass('action-btn')) {
                e.stopPropagation();
                let currentMenu = $(e.target).next('.dropdown-menu');
        ...
        // DataTable Initialization for Contacts Table
        ...
        // DataTable Initialization for Partners Table
        var partnersTable = $('#partnersTable').DataTable({
            ...
            language: {
                ...
                emptyTable: "Aucun partenaire disponible"
            },
            columnDefs: [{
                orderable: false,
                targets: [0, 6]
        ...
        $('#partnersSearch').on('keyup', function() {
            partnersTable.search(this.value).draw();
        });

        // Modal Logic for Tab 1
        $('#addContactBtnTab1').on('click', function() {
            $('#modalObjectifs').css('display', 'flex');
        });

        // Close modal when clicking outside of it
        $('#modalObjectifs').on('click', function(e) {
            if (!$(e.target).closest('#popupContainerObjectifs').length) {
                $(this).css('display', 'none');
            }
        });

        // Modal Logic for Tab 2
        $('#addContactBtnTab2').on('click', function() {
            $('#modalDocumentsManquants').css('display', 'flex');
        });

        // Close modal when clicking outside of it
        $('#modalDocumentsManquants').on('click', function(e) {
            if (!$(e.target).closest('#popupContainerDocumentsManquants').length) {
                $(this).css('display', 'none');
            }
        });

        // NOTE: Quill initialization for the second modal has been removed.
    });
    </script>
