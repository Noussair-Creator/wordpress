...
.pagination-controls .paging_simple_numbers .paginate_button {
    color: red !important;
    ...
    <div class="popup-container" id="popupContainerObjectifs">
        ...
        <form class="popup-form">
            ...
            <div class="phone-input-container">
                <span class="country-flag"><img style=" width: 40px; border-radius: 5px;"
                        src="/wp-content/plugins/plateforme-master/images/newimages/Image 30.png"
                        alt="Image 30.png"></span>
...
$(document).ready(function() {
    ...
    var contactsTable = $('#contactsTable').DataTable({
        ...
        language: {
            paginate: {
                first: "<i class='fas fa-angle-double-left' style='color:red'></i>",
                previous: "<i class='fas fa-angle-left' style='color:red'></i>",
                next: "<i class='fas fa-angle-right'style='color:red'></i>",
                last: "<i class='fas fa-angle-double-right'style='color:red'></i>"
            },
