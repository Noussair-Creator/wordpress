<div class="content-block">
  <div class="header-bar">
    <h2>
      ...
      Tableau de suivi des conventions
    </h2>
  </div>
  ...
  <table id="candidaturesTable" class="styled-table display">
    <thead>
      <tr>
        ...
        <th>Doctorant</th>
        <th>Discipline</th>
        <th>Université partenaire</th>
        <th>Pays</th>
        <th>Date De Demande</th>
        <th>Statut</th>
        <th>Mobilité Prévue</th>
        <th>Actions</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td>France</td>
        <td>01/03/2025</td>
        <td><span class="badge badge-success">Signée</span></td>
        <td>3 Mois (Janv–Mars)</td>
        <td>
          <div class="actions">
      ...
      <tr>
        ...
        <td>Mathématiques</td>
        <td>Université De Florence</td>
        <td>Italie</td>
        <td>01/03/2025</td>
        <td><span class="badge badge-warning">En attente</span></td>
        <td>6 Mois (Fév–Juin)</td>
        <td>
          <div class="actions">
            <button class="action-btn">⋮</button>
            <div class="dropdown-menu">
