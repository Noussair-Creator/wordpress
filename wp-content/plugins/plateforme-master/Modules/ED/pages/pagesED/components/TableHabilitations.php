<div class="content-block">
  ...
  <div class="filter-bar">
    <div class="filter-selectgb">
      <select class="filter-select">
        <option>École Doctorale</option>
        <option>École Doctorale 1</option>
        <option>École Doctorale 2</option>
      </select>
 ...
 <tbody>
  ...
  <tr>
    ...
    <td>Maître Conférence</td>
    <td>Arts Et Multimédia</td>
    <td>10/04/2025</td>
    <td><span class="badge badge-warning">En cours</span></td>
    <td>Commission N°2</td>
    <td>
      <div class="actions">
        <button class="action-btn">⋮</button>
        <div class="dropdown-menu">
