...
<head>
  <meta charset="UTF-8">
  <title> Financements Et Conformité</title>
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-lg-10 p-0">
        ...
        <div class="content p-4">
          <?php include 'components/Statistiques/statFinancements-et-conformite.php'; ?>

          <?php include 'components/TableFinancements-et-conformite.php'; ?>
