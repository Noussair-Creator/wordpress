    ...
    <div class="row">
      ...
      <div class="col-md-9 col-lg-10 p-0">
        ...
        <div class="content p-4">
          <?php include 'components/Statistiques/statCandidatures-ed_comissionEd.php'; ?>

          <?php include 'components/TableCandidatures-ed_comissionEd.php'; ?>
