    ...
    <nav class="main-nav">
      <a class="logo-link" href="#">
        <div class="logo-container">
          <img class="logo-svg" src="/wp-content/plugins/plateforme-master/images/SiteRechercheImages/Groupe 3291.png"
            alt="Groupe 3291.png">
        </div>
      </a>
      ...
      <div class="nav-links-container collapse" id="mainNavbar">
        <ul class="nav-links-list">
          ...
          <li class="nav-separator">|</li>
          <li class="nav-link-item"><a href="/ouverture-sur-lenvironnement-utm">Ouverture sur l'environnement</a></li>
          <li class="nav-separator">|</li>
