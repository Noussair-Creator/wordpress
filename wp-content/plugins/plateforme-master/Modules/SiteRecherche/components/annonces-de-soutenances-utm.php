...
<section class="hero-bg text-white">
    <div class="d-flex align-items-center" style="min-height: 425px; background-color: rgba(10, 20, 40, 0.5);">
        <div class="container">
            <a href="#" class="text-white text-decoration-none mb-2 d-inline-block"><i
                    class="fas fa-arrow-left me-2"></i>Retour</a>
            <h1 class="display-5 fw-bold">Annonces de soutenances</h1>
        </div>
    </div>
</section>
...
<main class="container main-content">
    ...
    <section class="col-lg-10 mx-auto">
        <div id="soutenancesGrid" class="row">
            <!-- Project Card 1 -->
