<section id="suivi-rec">
    ...
    <div class="sr-card">
        ...
        <!-- Pagination -->
        <div class="sr-pager">
            <button class="sr-btn" title="Première page"><i class="fa-solid fa-angles-left"></i></button>
            <button class="sr-btn" title="Précédent"><i class="fa-solid fa-angle-left"></i></button>
            <div class="sr-num-container" id="sr-page-numbers"></div>
            <button class="sr-btn" title="Suivant"><i class="fa-solid fa-angle-right"></i></button>
            <button class="sr-btn" title="Dernière page"><i class="fa-solid fa-angles-right"></i></button>
        </div>
    </div>
    ...
    (function() {
        ...
        const pageNumContainer = root.querySelector('#sr-page-numbers');
        ...
        const btnPrev = pager.querySelector('button[title="Précédent"]');
        const btnNext = pager.querySelector('button[title="Suivant"]');
        const btnLast = pager.querySelector('button[title="Dernière page"]');
        ...
        function updatePager() {
            ...
            for (let i = 1; i <= totalPages; i++) {
                ...
                btn.type = 'button';
                btn.className = `sr-page-btn ${i === PAGE ? 'active' : ''}`;
                btn.dataset.page = i;
                btn.textContent = i;
        ...
        function setupPagerEvents() {
            ...
            pageNumContainer.addEventListener('click', (e) => {
                if (e.target.matches('.sr-page-btn')) {
