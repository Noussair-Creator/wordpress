        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <img width="40px" src="/wp-content/plugins/plateforme-master/images/icons/3329498.png"
                        alt="3329498.png">
                    Historique
                </div>
                <div class="card-body">
                        ...
                        <li class="timeline-item">
                            <div class="timeline-icon">
                                <div class="icon-wrapper bg-danger-soft">
                                    <img width="20px"
                                        src="/wp-content/plugins/plateforme-master/images/icons/27) Icon-external-link.png"
                                        alt="Icon-external-link.png">
                                </div>
                            </div>
                            <div class="timeline-content">
                                <h6>12 aout 2025</h6>
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-6 col-xl-3">
                            <div class="stat-card">
                                <div class="d-flex align-items-center mb-2">
                                    <i class="fa-regular fa-calendar-days stat-card-icon"></i>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="stat-card">
                                <div class="d-flex align-items-center mb-2">
                                    <i class="fa-regular fa-clock stat-card-icon"></i>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="stat-card">
                                <div class="d-flex align-items-center mb-2">
                                    <i class="fa-regular fa-square-check stat-card-icon"></i>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="stat-card danger">
                                <div class="d-flex align-items-center mb-2">
                                    <i class="fa-solid fa-triangle-exclamation stat-card-icon"></i>
                                    <h3 class="mb-0">12</h3>
                                </div>
