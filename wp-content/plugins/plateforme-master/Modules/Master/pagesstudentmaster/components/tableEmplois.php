...
<style>
  ...
  *{box-sizing:border-box}
  body{margin:0;background:#f3f4f6;font-family:var(--font);color:var(--ink)}

  /* Carte globale */
  .edt-card{
    background:#fff;border:1px solid #e8e9ea;border-radius:12px;
  ...
  .edt-head .icon{width:38px;height:38px}
  .edt-head .icon img{width:100%;height:100%;object-fit:contain}
  .edt-head .title{font-weight:700;font-size:20px;line-height:26px}
  .upload-btn{
    margin-left:auto;width:40px;height:40px;border-radius:5px;background:#fff;
    box-shadow:var(--btnshadow);display:grid;place-items:center;
  }
  .upload-btn img{width:16px;height:17px}

  .sep{border:0;border-top:1px solid var(--line);margin:8px 0 10px}
  ...
  .info .grp,.info .date{font-weight:700;font-size:18px}

  /* ===== TABLEAU HORAIRE ===== */
  .edt-table{width:100%;border-collapse:separate;border-spacing:0}
  .edt-table col.col-time{width:90px}       /* colonne fixe pour les heures */
  .edt-table col.col-day{width:auto}         /* 6 colonnes jours, flexibles */

  /* head */
  .edt-table thead th{
    background:#ECEBE3;
    padding:12px 10px;font-weight:700;font-size:16px;text-align:center;
  }
  ...
  .edt-table tbody th{
    ...
    font-weight:500;font-size:15px;padding:10px;
  }
  .edt-table tbody td{
    vertical-align:top;padding:10px;min-height:140px;
  }

  /* Slots (cours) */
  .slot{
    background:var(--slot);border:1px solid var(--slot-b);border-radius:5px;
    padding:10px;min-height:120px;position:relative;
  }
  .slot .title{font-weight:500;font-size:14px;line-height:19px}
  .slot .teacher{margin-top:8px;font-weight:300;font-size:14px;line-height:19px}
  .room{margin-top:14px;position:relative;padding-left:37px}
  .room .label{
    position:absolute;left:0;top:0;width:37px;font:400 14px/19px var(--font);color:#6E6D55;
  }
  .room .value{
    font-weight:700;font-size:14px;line-height:19px;color:#2A2916;
  }
      ...
      <tr>
        ...
        <td>
          <div class="slot">
            ...
            <div class="room"><span class="label">Salle&nbsp;:</span><span class="value">A12 bis</span></div>
          </div>
        </td>
        <td></td>
        <td></td>
