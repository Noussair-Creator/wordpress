...
<style>
/* === CSS FOR THE ICON WITH NUMBERED BADGE === */

/* The container for the icon and its badge.
           position: relative is crucial for positioning the badge. */
.icon-with-badge {
    position: relative;
    display: inline-block;
    /* Ensures the container only takes up the space of its content */
}

/* Styling for the main icon (the paperclip) */
...
/* Styling for the numbered badge */
.icon-badge {
    position: absolute;
    top: -10px;
    /* Position it slightly above the top edge of the container */
    right: -13px;
    /* Position it slightly to the right of the container */

    background-color: #c8c8b8;
    /* The beige/gray background from the screenshot */
    color: #fff;

    border-radius: 50%;
    /* Makes the badge a perfect circle */
    width: 16px;
    height: 16px;
...
/* Added style for date input padding */
...
/* Override for icon buttons to match the new design */
.filter-bar .icon-btn {
    width: 42px;
    height: 42px;
    border: 1px solid #e0e0e0;
...
/* === END OF STYLES FOR NEW FILTER BAR === */
