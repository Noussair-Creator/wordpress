...
<div class="content-wrapper">
    ...
    <!-- Informations générales & Objectifs du projet block -->
    <div class="card full-width">
        ...
        <!-- Using a custom ordered list for the numbered objectives -->
        <ol class="custom-ordered-list">
            <li> Développer une interface neuronale portable basée sur des casques EEG à faible coût, interfacée avec
                une application mobile.</li>
            <li>Intégrer un module d’intelligence artificielle permettant la reconnaissance de signaux moteurs
                intentionnels à partir de données brutes EEG.</li>
            <li>Tester cliniquement le dispositif sur un échantillon de patients atteints de troubles moteurs (10 cas
                suivis).</li>
            <li>Optimiser les performances du dispositif en conditions réelles et publier les résultats.</li>
            <li>Former deux doctorants dans le cadre du projet (signal + clinique).</li>
        </ol>
    </div>

    <!-- Équipe du projet block -->
    <div class="card full-width">
    ...
    <!-- Pièces jointes associées au projet block -->
    <div class="card full-width">
