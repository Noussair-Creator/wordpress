...
<head>
    ...
    <style>
        ...
        /* FIX: Ensure Flatpickr calendar is on top of the modal */
        .flatpickr-calendar {
            z-index: 1000000;
            /* position: fixed;
            bottom: 0;
        ...
        /* Custom style for Flatpickr calendar */
        .my-custom-calendar-depense {
            top: 338px !important;
            left: 1547px !important;
            right: 0px !important;
        }

        .my-custom-calendar-prevu {
            top: 390px !important;
            left: 1547px !important;
            right: 0px !important;
        }
...
<body>
    ...
    <script>
       ...
       /* flatpickr("#date-depense", {
            ...
            dateFormat: "d/m/Y",
            locale: "fr",
            // This is the fix: we append the calendar to the modal container
            // so it scrolls with the modal instead of staying in a fixed position.
            appendTo: document.getElementById('popupContainerDepense'),
            onChange: function () {
                applyFilters();
            },
        ...
        flatpickr("#date-prevu", {
            ...
            dateFormat: "d/m/Y",
            locale: "fr",
            appendTo: document.getElementById('popupContainerLivrables'),
            onOpen: function (selectedDates, dateStr, instance) {
                // Add your custom class to the calendar container
                instance.calendarContainer.classList.add('my-custom-calendar-prevu');
            }
        });
    </script>
