...
<head>
    <meta charset="UTF-8">
    <title>RÉSERVATION DES ÉQUIPEMENTS ET SALLES</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-0">
                ...
                <div class="content p-4">
                    ...
                    <?php include 'components/statreservation-des-equipements-et-salles.php'; ?>


                    <?php include 'components/Tablereservation-des-equipements-et-salles.php'; ?>
