...
<head>
    <meta charset="UTF-8">
    <title>Activites Quotidiennes</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-0">
                ...
                <div class="content p-4">
                    ...
                    <?php include 'components/statActivitesQuotidiennesDirecteurLabo.php'; ?>
                    <?php include 'components/TableActivitesQuotidiennesDirecteurLabo.php'; ?>
