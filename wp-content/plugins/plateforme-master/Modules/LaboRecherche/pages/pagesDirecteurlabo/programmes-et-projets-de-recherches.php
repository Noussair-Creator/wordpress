...
<head>
    <meta charset="UTF-8">
    <title>Programmes Et Projets De Recherches</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-0">
                ...
                <div class="content p-4">
                    ...
                    <?php include 'components/statProgrammesEtProjetsDeRecherches.php'; ?>
                    <?php include 'components/TableProgrammesEtProjetsDeRecherches.php'; ?>
