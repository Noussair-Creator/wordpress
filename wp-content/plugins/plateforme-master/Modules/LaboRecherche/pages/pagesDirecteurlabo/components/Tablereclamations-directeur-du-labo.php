...
#demandes-service .table-head table {
    width: 100%;
...
#demandes-service .table-head th:first-child {
    width: 32px;
    text-align: center;
    padding-left: 6px
}

#demandes-service .table-head th:nth-child(2) {
    width: 140px
}

#demandes-service .table-head th:nth-child(3) {
    width: 230px
}
...
#demandes-service .table-head th:nth-child(5) {
    width: 120px;
    text-align: center
}

#demandes-service .table-head th:nth-child(6) {
    width: 120px;
    text-align: center
}

#demandes-service .table-head th:nth-child(7) {
    width: 90px;
    text-align: center
}

/* ====== TABLE BODY ====== */
#demandes-service .table-body {
    background: #fff;
...
#demandes-service .tbl tr:last-child td {
    border-bottom: none
}
...
<section class="card" id="demandes-service">
    ...
    <div class="toolbar">
        <div class="search">
            ...
            <img src="/wp-content/plugins/plateforme-master/images/icons/27) Icon-search.png" alt="search">
        </div>
        <button class="btn-download" title="Télécharger">
            <img src="/wp-content/plugins/plateforme-master/images/icons/upload-red.png" alt="download">
        </button>
    </div>
        ...
        <table class="tbl">
            <tbody>
                ...
                <tr class="rel" data-ref="Rec-2025-002" data-student="Hatem Z." data-type="Administration"
                    data-subject="Problème de stage" data-sent="12-02-2025" data-status="Refusée" data-attachments="–"
    ...
    <div class="pagination">
        <button class="pbtn arrow" title="Première"><i class="fa-solid fa-angles-left"
                style="color: #C40000;"></i></button>
        <button class="pbtn arrow" title="Précédent"><i class="fa-solid fa-angle-left"
                style="color: #C40000;"></i></button>
        <button class="pbtn page active" title="Page 2">2</button>
        <button class="pbtn arrow" title="Suivant"><i class="fa-solid fa-angle-right"
                style="color: #C40000;"></i></button>
        <button class="pbtn arrow" title="Dernière"><i class="fa-solid fa-angles-right"
                style="color: #C40000;"></i></button>
    </div>
