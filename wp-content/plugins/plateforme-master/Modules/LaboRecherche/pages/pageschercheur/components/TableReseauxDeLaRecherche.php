        ...
        <form class="popup-form">
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <select id="typeCollaboration">
                        <option>Sélection..</option>
                        <option value="">Projet De Recherche H2020</option>
                        <option value="">Cotutelle Doctorale</option>
                        <option value="">Article Scientifique</option>
                        <option value="">Échange & Co-Pub</option>
                        <option value="">Projet Bilatéral</option>
                    </select>
                    <i class="fas fa-chevron-down icon right-icon"></i>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-file-wrapper">
                    <input type="text" class="input-file-text" placeholder="Aucun fichier choisi" style="border: none;"
                        readonly>
                    <label for="fileUpload" class="btn-importer"><i class="fas fa-upload"></i> Importer</label>
