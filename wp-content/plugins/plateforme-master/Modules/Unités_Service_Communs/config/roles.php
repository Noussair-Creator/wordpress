...
// ... au même endroit où tu définis "um_responsable_uscr"
"um_responsable_uscr" => [
  ...
  "menu" => [
    ...
    ["label" => "Réservation & Planning",    "lien" => "/reservation-planning", "icon" => "images/uscr/27) Icon-file-text.png"],
    ["label" => "Maintenance & Incidents",   "lien" => "/maintenance-incidents", "icon" => "images/uscr/27) Icon-settings-2.png"],
    ...
    ["label" => "Budgets",                   "lien" => "/budgets",       "icon" => "images/uscr/dollar-circle-list-svgrepo-com.png"],
    ["label" => "Contacts",                  "lien" => "/contacts",      "icon" => "images/uscr/27) Icon-phone.png"],
    ["label" => "Réclamations",              "lien" => "/reclamations",  "icon" => "images/uscr/27) Icon-alert-triangle.png"],
