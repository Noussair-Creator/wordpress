...
<div class="content-block">
    <div class="header-bar">
        <h2 class="dashboard-sub-title">
            <img src="/wp-content/plugins/plateforme-master/images/icons/9368448.png" alt="Icon" width="32px">
            Réunions
        </h2>
        <a href="#" id="openModalBtn" class="add-project-btn"><i class="fas fa-plus" style="margin-right: 6px;"></i>
            Programmer une réunion</a>
    </div>
    ...
    <table id="candidaturesTable" class="styled-table display">
        ...
        <tbody>
            <!-- THIS SECTION IS NOW EMPTY. DATA WILL BE LOADED BY REUNION.JS -->
        </tbody>
    </table>
    ...
    <div class="popup-container">
        ...
        <form class="popup-form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <input type="file" id="meetingFile" name="meetingFile"                          
...
<div class="modal-overlay" id="editMeetingModal">
    <div class="popup-container">
        <div class="popup-header">
            ...
            <div class="header-actions">
                <button class="btn-enregistrer" id="updateMeetingBtn">Enregistrer</button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        setTimeout(function() {
            if ($.fn.DataTable.isDataTable('#candidaturesTable')) {
                ...
                console.warn('DataTable not found - reunion.js may not have loaded yet');
            }
        ...
        participantEmailInput.addEventListener('keypress', (e) => {
            if (e.key === 'Enter') {
                e.preventDefault();
                addParticipant(participantEmailInput, participantList);
            }
        });
        ...
        editParticipantEmailInput.addEventListener('keypress', (e) => {
            if (e.key === 'Enter') {
                e.preventDefault();
                addParticipant(editParticipantEmailInput, document.getElementById('editParticipantList'));
            }
        });
